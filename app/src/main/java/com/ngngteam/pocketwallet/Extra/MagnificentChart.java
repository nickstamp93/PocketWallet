package com.ngngteam.pocketwallet.Extra;
...
// #MARK - Constructors
    ...
    public MagnificentChart(Context context, List<MagnificentChartItem> itemsList, double maxValue){
        super(context);
        init(context, itemsList, maxValue, false, false, true, false, Color.parseColor("#DDDDDD"), Color.parseColor("#FFFFFF"));
    }

    public MagnificentChart(Context context, List<MagnificentChartItem> itemsList, double maxValue, boolean isAnimated, boolean isRound, boolean showShadow, boolean showTitle){
        super(context);
...
// #MARK - Custom methods
    ...
    private void init(Context context, List<MagnificentChartItem> itemsList, double maxValue, boolean isAnimated, boolean isRound, boolean showShadow, boolean showTitle, int shadowColor, int backgroundColor){
...
// #MARK - Drawing Methods
    ...
    private void drawItems(Canvas canvas, RectF mainRectangle){
        ...
        for(int i = 0; i < chartItemsList.size(); ++i){
            ...
            double currentAngle = currentPercentValue * 360;
            anglesSum += currentAngle;
            currentPaint.setColor(color);
            canvas.drawArc(mainRectangle, startAngle, (float)currentAngle, true, currentPaint);
